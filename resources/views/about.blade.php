    ...
    <div class="pt-9">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
                ...
                <div class="pl-80   ">
                    <img src="{{ asset('images/visi.png') }}" alt="Visi" class="rounded-lg">
                </div>
            </div>
            ...
            <div data-aos="fade-up" class="mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 ">
                    <div class="bg-white p-6 rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-xl">
            ...
            <div data-aos="fade-up" >
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <!-- Team Member 1 -->
                    <div class="bg-white p-6 rounded-lg shadow-md text-center overflow-hidden transition duration-300 hover:shadow-xl">
                        <img src="{{ asset('images/felix.jpg') }}"  alt="Member 1" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
                        <h3 class="text-xl font-semibold mb-1">Ega Felix</h3>
                        <p class="text-gray-600">CEO & Founder</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md text-center overflow-hidden transition duration-300 hover:shadow-xl">
                        <img src="{{ asset('images/rifki.jpg') }}" alt="Member 2" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
                        <h3 class="text-xl font-semibold mb-1">Rifki Almahdi</h3>
                        <p class="text-gray-600">CEO & Founder</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md text-center overflow-hidden transition duration-300 hover:shadow-xl">
                        <img src="{{ asset('images/agil.jpg') }}" alt="Member 3" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
