                    ...
                    <form action="{{ route('admin.bookings.update', $booking->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="lapangan_id" 
                                ...
                                @foreach($lapangan as $lap)
                                    <option value="{{ $lap->id }}" 
                                            {{ old('lapangan_id', $booking->lapangan_id) == $lap->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" 
                                   name="tanggal" 
                                   id="tanggal" 
                                   value="{{ old('tanggal', $booking->tanggal->format('Y-m-d')) }}"
                                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                   required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="catatan" 
                                      id="catatan" 
                                      rows="3"
                                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('catatan', $booking->catatan) }}</textarea>
                        </div>
