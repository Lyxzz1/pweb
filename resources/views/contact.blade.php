...
<head>
    ...
    <title>Contact - Sportstation</title>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-8">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="flex space-x-4">
                                <a href="#" class="text-gray-400 hover:text-red-600 transition duration-500">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-8">
                        ...
                        <form action="{{ route('contact.store') }}" method="POST">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" 
                                        class="bg-red-500 transition duration-300 hover:bg-red-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                    Kirim Pesan
                                </button>
                            </div>
                        </form>
