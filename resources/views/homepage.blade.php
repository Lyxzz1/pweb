                ...
                <div class="flex items-center h-full">
                    <div class="w-full md:w-1/2 text-white">
                        ...
                        <div class="space-x-4">
                            ...
                            <a href="#lapangan" 
                               class="border-2 border-white text-white px-6 py-3 rounded-md font-semibold hover:bg-white hover:text-blue-600">
                                Lihat Lapangan
                            </a>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-blue-600 font-bold">Rp {{ number_format($lap->harga, 0, ',', '.') }}/jam</span>
                            @auth
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-6 text-center">
                        <div>
                            <h4 class="text-3xl font-bold text-blue-600">1000+</h4>
