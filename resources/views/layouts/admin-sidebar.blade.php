        ...
        <ul class="space-y-2 px-4">
            ...
            <li>
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center px-4 py-2 text-gray-200 hover:bg-gray-700 rounded-md {{ request()->routeIs('admin.dashboard') ? 'bg-red-700' : '' }}">
            ...
            <li>
                <a href="{{ route('admin.lapangan.index') }}"
                    class="flex items-center px-4 py-2 text-gray-200 hover:bg-gray-700 rounded-md {{ request()->routeIs('admin.lapangan.*') ? 'bg-red-700' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.bookings.index') }}"
                    class="flex items-center px-4 py-2 text-gray-200 hover:bg-gray-700 rounded-md {{ request()->routeIs('admin.bookings.*') ? 'bg-red-700' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.profile.edit') }}"
                    class="flex items-center px-4 py-2 text-gray-200 hover:bg-gray-700 rounded-md {{ request()->routeIs('admin.profile.*') ? 'bg-red-700' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
