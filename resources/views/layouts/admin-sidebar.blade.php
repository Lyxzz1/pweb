<div class="flex flex-col min-h-screen bg-gray-800 w-64">
    ...
    <div class="flex items-center justify-center h-20 bg-gray-900">
        <div class="flex items-center">
            ...
            <span class="text-white text-xl font-semibold ml-2">Sportstation</span>
        </div>
    </div>
        ...
        <ul class="space-y-2 px-4">
            ...
            <li>
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center px-4 py-2 text-gray-200 hover:bg-gray-700 rounded-md {{ request()->routeIs('admin.dashboard') ? 'bg-gray-700' : '' }}">
            ...
            <li>
                <a href="{{ route('admin.lapangan.index') }}"
                    class="flex items-center px-4 py-2 text-gray-200 hover:bg-gray-700 rounded-md {{ request()->routeIs('admin.lapangan.*') ? 'bg-gray-700' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.bookings.index') }}"
                    class="flex items-center px-4 py-2 text-gray-200 hover:bg-gray-700 rounded-md {{ request()->routeIs('admin.bookings.*') ? 'bg-gray-700' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.profile.edit') }}"
                    class="flex items-center px-4 py-2 text-gray-200 hover:bg-gray-700 rounded-md {{ request()->routeIs('admin.profile.*') ? 'bg-gray-700' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <form method="POST" action="{{ route('admin.logout') }}">
                @csrf
                    <button type="button" onclick="openLogoutModal()"
                        class="flex items-center w-full px-4 py-2 text-gray-200 hover:bg-gray-700 rounded-md">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
